...
Summary: 
Good structure and commits, but needs better docs and license.

Roadmap:
1. Add proper README with setup instructions
2. Add LICENSE file
3. Set up CI/CD
```
...
Backend runs on port 3001, frontend on 3000. You can change the backend URL via `NEXT_PUBLIC_BACKEND_URL` env variable.
...
✅ Generates 0-100 score with categories  
✅ Generates summary  
